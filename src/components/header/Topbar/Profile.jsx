      ...
      >
        <MenuItem onClick={handleDialogOpen}>
          <Avatar
            ...
            src={appContext?.userInfo?.picture}
          />
          {appContext?.userInfo?.data?.name || "user"}
        </MenuItem>
            ...
            <Grid item xs={6}>
              <Box mb={2}>
                ...
                <TextField
                  ...
                  variant="outlined"
                  size="small"
                  value={appContext?.userInfo?.name || ""}
                />
              </Box>
              <Box mb={2}>
                ...
                <TextField
                  ...
                  variant="outlined"
                  size="small"
                  value={appContext?.userInfo?.username || ""}
                />
              </Box>
              <Box mb={2}>
                ...
                <TextField
                  ...
                  variant="outlined"
                  size="small"
                  value={appContext?.userInfo?.role === 1 ? "Admin" : "user"}
                />
              </Box>
              <Box mb={2}>
                ...
                <TextField
                  ...
                  variant="outlined"
                  size="small"
                  value={appContext?.userInfo?.phone || ""}
                />
              </Box>
              <Box mb={2}>
                ...
                <TextField
                  ...
                  size="small"
                  type="date"
                  value={appContext?.userInfo?.birthdate || ""}
                />
              </Box>
              <Box mb={2}>
                ...
                <TextField
                  ...
                  variant="outlined"
                  size="small"
                  value={appContext?.userInfo?.email || ""}
                />
              </Box>
            </Grid>
            ...
            <Grid item xs={6}>
              <Box mb={2}>
                ...
                <TextField
                  ...
                  variant="outlined"
                  size="small"
                  value={appContext?.userInfo?.address || ""}
                />
              </Box>
              <Box mb={2}>
              ...
              <Box mb={2}>
                ...
                <TextField
                  ...
                  multiline
                  rows={4}
                  value={appContext?.userInfo?.note || ""}
                />
              </Box>
            </Grid>
          </Grid>
