...
import { supplierService } from "@/services/supllier/supplier.service";
  ...
  return (
    <div>
      ...
      >
        ...
        <Typography>{handleformat.formatPrice(total)}</Typography>
      </Stack>
      ...
      >
        ...
        <Typography>{handleformat.formatPrice(finalTotal)}</Typography>
      </Stack>
